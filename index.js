...
//             let conn = distube.client.voice.connections.find(x => x.channel.guild.id == message.member.guild.id)
//             if((conn && message.member.voice.channel.id == conn.channel.id) || (!conn))
//                 distube.play(message, args.join(" "));
//             else if(conn && message.member.voice.channel.id != conn.channel.id) {
//                 return message.channel.send("You can't play music if you are not in the same channel as the bot!")
//             }
